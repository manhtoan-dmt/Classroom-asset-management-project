                        ...
                        <div class="container mt-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Asset ID :</div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-3 fw-bold">Warranty :</div>
                                        <div class="col-md-9">${asset.warranty} months</div>
                                    </div>
                            ...
                            <div class="mt-4">
                                <a href="assetList" class="btn btn-secondary">Back</a>
                            </div>
