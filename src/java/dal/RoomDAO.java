...
public class RoomDAO extends DBContext {
    ...
    public int getStorageRoomId() {
        ...
        try {
            ...
            String sql = "SELECT room_id FROM rooms WHERE room_code = 'STORAGE'";
    ...
    public List<Room> getAllRoomsType() {

        List<Room> list = new ArrayList<>();

        try {

            String sql = "SELECT room_id, room_code FROM rooms WHERE room_code <> 'STORAGE'";
